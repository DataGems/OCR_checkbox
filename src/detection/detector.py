...
Handles training, inference, and evaluation of YOLOv8 models for checkbox localization.
"""
...
class CheckboxDetector:
    """
    YOLOv8-based checkbox detector for document images.
    """
    ...
    def train(
        ...
        """
        Train YOLOv8 model on checkbox detection dataset.
        ...
        print(f"Starting YOLOv8 training with config: {self.config.model_name}")
    ...
    def _parse_yolo_result(self, result) -> Dict[str, Any]:
        """
        Parse YOLOv8 result object into standardized format.
